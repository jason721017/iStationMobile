cordova.define("estimote.estimoteBeacons", function (require, exports, module) {


    var exec = require('cordova/exec');

    var estimoteBeacons = module.exports;
    ...
    estimoteBeacons.startEstimoteBeaconsDiscoveryForRegion = function (successCallback) {
    ...
    estimoteBeacons.stopEstimoteBeaconsDiscoveryForRegion = function (successCallback) {
        if (typeof successCallback !== "function") {
    ...
    estimoteBeacons.startRangingBeaconsInRegion = function (successCallback) {
        if (typeof successCallback !== "function") {
    ...
    estimoteBeacons.stopRangingBeaconsInRegion = function (successCallback) {
        if (typeof successCallback !== "function") {
    ...
    estimoteBeacons.startMonitoringForRegion = function (major, minor, id, successCallback) {
        if (!isInt(major)) {
    ...
    estimoteBeacons.stopMonitoringForRegion = function (id, successCallback, errorCallback) {
    ...
    estimoteBeacons.setFrequencyOfConnectedBeacon = function (frequency, successCallback, errorCallback) {
        if (errorCallback === null) {
            errorCallback = function () {
            }
        }
    ...
    estimoteBeacons.getMyDeviceToken = function (successCallback) {
        if (typeof successCallback !== "function") {
            console.error("EstimoteBeacons.getDeviceToken failure: success callback parameter must be a function");
            return;
        }
